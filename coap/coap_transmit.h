...
#ifndef COAP_TRANSMIT_H_
#define COAP_TRANSMIT_H_
...
void coap_tcp_xmit_reset(uint16_t message_id, wiced_udp_socket_t *socket, wiced_ip_address_t *remote_ip, uint16_t remote_port );
#endif /* COAP_TRANSMIT_H_ */
