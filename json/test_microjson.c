...
{
    if (status != 0) {
	(void)fprint_status(stderr, "case %d FAILED, status %d (%s).\n", num,
...
int main(int argc, char *argv[])
{
    ...
    (void)fprint_status(stderr, "microjson unit test ");
    ...
    (void)fprint_status(stderr, "succeeded.\n");
